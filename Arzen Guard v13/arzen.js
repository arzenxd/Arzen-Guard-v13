{
    ...
    client.on("guildBanAdd", async function (guild, user) {
        ...
        guild.members.ban(entry.executor.id, { reason: "Arzen ban Koruma" })
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("guildMemberRemove", async kickhammer => {
        ...
        if (entry.action == `MEMBER_KICK`) {
            ...
            kickhammer.guild.members.ban(yetkili.id, { reason: "Arzen kick koruma" })
            let channel = client.channels.cache.get(ayarlar.log1)
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("guildMemberAdd", async member => {
        ...
        if (member.user.bot) {
            ...
            member.guild.members.ban(entry.executor.id, { reason: "Arzen Bot Koruma" })
            member.guild.members.ban(member.id, { reason: "Arzen Bot Koruma" })
            let channel = client.channels.cache.get(ayarlar.log1)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on('guildUpdate', async (oldGuild, newGuild) => {
        ...
        newGuild.members.ban(entry.executor.id, { reason: "Arzen URL Koruma" })
        let channel = client.channels.cache.get(ayarlar.log1)
    ...
    client.on("guildUpdate", async (oldGuild, newGuild) => {
        ...
        newGuild.members.ban(entry.executor.id, { reason: `Arzen Güncelleme Koruma` });
        const moment = require('moment');
        moment.locale('tr');
        let channel = client.channels.cache.get(ayarlar.log1)
    ...
    client.on("roleDelete", async role => {
        ...
        role.guild.members.ban(entry.executor.id, { reason: `Arzen Rol Silme Koruma` });
        let channel = client.channels.cache.get(ayarlar.log1)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("roleUpdate", async (oldRole, newRole) => {
        ...
        newRole.guild.members.ban(entry.executor.id, { reason: `Arzen Rol Güncelleme Koruma` });
        let channel = client.channels.cache.get(ayarlar.log1)
...
**Yetkilinin yetkileri alınıp karantinaya atıldı!**`)
    ...
    client.on("channelDelete", async channel => {
        ...
        channel.guild.members.ban(entry.executor.id, { reason: `Arzen kanal Silme Koruma` });
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("webhookUpdate", async (channel) => {
        ...
        channel.guild.members.ban(entry.executor.id, { reason: "Arzen Weebhook Koruma" }).catch(err => { });
        channel.guild.roles.cache.forEach(async function (jahky) {
            if (jahky.permissions.has("ADMINISTRATOR") || jahky.permissions.has("BAN_MEMBERS") || jahky.permissions.has("MANAGE_GUILD") || jahky.permissions.has("KICK_MEMBERS") || jahky.permissions.has("MANAGE_ROLES") || jahky.permissions.has("MANAGE_CHANNELS")) {
                jahky.setPermissions(0).catch(err => { });
            }
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client1.on('guildUpdate', async (oldGuild, newGuild) => {
      ...
      **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
        ...
        request({
            method: 'PATCH',
            url: `https://Discord1.com/api/v8/guilds/${newGuild.id}/arzen-url`,
            body: {
                code: ayarlar1.url
            },
            json: true,
